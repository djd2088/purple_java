 ...
 * @version 2018-06-12
 */
public class RuiProductProperty extends DataEntity<RuiProductProperty> {
	...
	public RuiProductProperty() {
		super();
	}

	public RuiProductProperty(String id){
		super(id);
	}
	...
	@Length(min=0, max=1000, message="json长度必须介于 0 和 1000 之间")
	...
	@Length(min=0, max=255, message="property_type长度必须介于 0 和 255 之间")
