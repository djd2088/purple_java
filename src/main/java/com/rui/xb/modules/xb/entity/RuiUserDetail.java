 ...
 * @version 2018-06-12
 */
public class RuiUserDetail extends DataEntity<RuiUserDetail> {
	...
	public RuiUserDetail() {
		super();
	}

	public RuiUserDetail(String id){
		super(id);
	}
	...
	@Length(min=0, max=50, message="real_name长度必须介于 0 和 50 之间")
