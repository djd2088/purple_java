...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "mall";
    ...
    public static String aesEncode(String content) {
        try {
            ...
            String aesEncode = new String(new Base64().encode(byteAES));
            //11.将字符串返回
            return aesEncode;
    ...
    public static String aesDecode(String content) {
        try {
            ...
            throw new RuntimeException("兄弟，配置文件中的密码需要使用AES加密，请使用com.wondersgroup.mall.common.util.AESUtil工具类修改这些值！");
            //e.printStackTrace();
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
