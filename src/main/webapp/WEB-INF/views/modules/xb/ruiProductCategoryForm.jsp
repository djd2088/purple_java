...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xb/ruiProductCategory/">单表列表</a></li>
		<li class="active"><a href="${ctx}/xb/ruiProductCategory/form?id=${ruiProductCategory.id}">单表<shiro:hasPermission name="xb:ruiProductCategory:edit">${not empty ruiProductCategory.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xb:ruiProductCategory:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
