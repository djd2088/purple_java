...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xb/ruiComplain/">单表列表</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<shiro:hasPermission name="xb:ruiComplain:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="ruiComplain">
			<tr>
				<shiro:hasPermission name="xb:ruiComplain:edit"><td>
    				<a href="${ctx}/xb/ruiComplain/form?id=${ruiComplain.id}">修改</a>
