...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xb/ruiProduct/">商品列表</a></li>
		<li class="active"><a href="${ctx}/xb/ruiProduct/form?id=${ruiProduct.id}">商品<shiro:hasPermission
				name="xb:ruiProduct:edit">${not empty ruiProduct.id?'审核与锁定':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xb:ruiProduct:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ruiProduct" action="${ctx}/xb/ruiProduct/save" method="post" class="form-horizontal">
		...
		<%--<div class="control-group">--%>
			<%--<label class="control-label">商品广告：</label>--%>
			<%--<div class="controls">--%>
