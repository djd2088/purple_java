...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xb/ruiComplain/">单表列表</a></li>
		<li class="active"><a href="${ctx}/xb/ruiComplain/form?id=${ruiComplain.id}">单表<shiro:hasPermission name="xb:ruiComplain:edit">${not empty ruiComplain.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xb:ruiComplain:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ruiComplain" action="${ctx}/xb/ruiComplain/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">final_handle_message：</label>
			<div class="controls">
				<form:input path="finalHandleMessage" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="xb:ruiComplain:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
